...
Used technologies: HTML, JavaScript (canvas), jQuery (events)

canvas_animation_bee.html

Draw a bee that flies randomly around the canvas. Draw bee using a number of circles. For bee animation program randomly change it position and draw the bee at new position for every step of anomation (by the setInterval).
